    ...
    <section className="mx-auto gap-20 flex flex-col items-center justify-between py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-20">
      <div className="flex gap-3">
        ...
        <div className="flex flex-col flex-1 gap-6">
          <div>
            {" "}
            Experience the benefits of our online marketplace. With buyer
            protection, you can shop worry-free knowing that your purchases are
            safeguarded. Our easy returns policy ensures a hassle-free shopping
            experience. Plus, our competitive pricing guarantees you'll find the
            best deals.
          </div>
          <div className="flex gap-3">
            <div>
